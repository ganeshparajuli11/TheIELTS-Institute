    ...
    <div className="space-y-5">
      ...
      <div className="rounded-lg border border-violet-200 bg-violet-50 px-4 py-3">
        <p className="text-sm text-violet-800">
          <strong>Phase 6 — Not yet implemented.</strong> The AI knowledge base will power a chatbot
          that answers common student questions. All knowledge must be reviewed before being used by
          the AI.
        </p>
      </div>
        ...
        <CardContent className="pb-5">
          <ul className="grid gap-2">
            {safetyNotes.map((note) => (
              <li key={note} className="text-muted-foreground flex items-start gap-2 text-sm">
