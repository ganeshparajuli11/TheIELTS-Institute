        ...
        <div className="container-page relative z-10 grid min-h-[calc(88vh-4.5rem)] items-center gap-12 py-20 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-white/90">
              Compare courses, intakes, locations, and academic fit before you apply. The goal is a
              shortlist that feels clear, realistic, and aligned with your future.
            </p>
          ...
          <div className="text-foreground shadow-primary/30 rounded-xl border border-white/25 bg-white/95 p-6 shadow-2xl backdrop-blur">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div className="bg-muted rounded-lg p-4">
                <p className="text-primary text-3xl font-extrabold">{universities.length}</p>
                <p className="text-muted-foreground mt-1 text-sm font-semibold">Sample profiles</p>
              </div>
              <div className="bg-muted rounded-lg p-4">
                <p className="text-primary text-3xl font-extrabold">{featured.length}</p>
                <p className="text-muted-foreground mt-1 text-sm font-semibold">Featured routes</p>
              </div>
            </div>
            <p className="text-muted-foreground mt-5 text-sm leading-6">
              These records are frontend-ready placeholders for future CMS university profiles and
          ...
          <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            <div>
              ...
              <p className="text-muted-foreground mt-4 text-lg leading-8">
                Use this section as the future browsing experience for managed university records.
                It keeps the design clean while preparing the structure for real data from the admin
                panel later.
              </p>
            </div>
        ...
        <div className="container-page grid gap-10 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="text-muted-foreground mt-5 text-lg leading-8">
              Featured profiles can later be controlled from the admin panel. For now, they show how
              priority university cards should appear without claiming verified partnerships.
            </p>
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="premium-card p-6">
              ...
              <p className="text-muted-foreground mt-3 leading-7">
                We compare course content, entry conditions, English readiness, and long-term study
                direction before applications begin.
              </p>
            </div>
            <div className="premium-card p-6">
              ...
              <p className="text-muted-foreground mt-3 leading-7">
                City, budget, intake timing, accommodation, and student support all matter when a
                Nepalese student chooses a UK route.
              </p>
            </div>
          </div>
        </div>
